...
let doc = DocumentApp.openById(docNuevo.getId());
...
//----------------------------------------------------------------------
  ...
  var win = window.open(`https://docs.google.com/document/d/${docNuevo.getId()}/edit`, '_blank');
...
//doc.getBody().appendImage("https://drive.google.com/uc?export=view&id=168eLF2ZFZ7zEBHFwPUTuBFReipmF7ozY/view?usp=sharing");

doc.getBody().appendImage("https://images.pexels.com/photos/11134135/pexels-photo-11134135.jpeg");
doc.getBody().appendImage().setLinkUrl("https://drive.google.com/uc?export=view&id=168eLF2ZFZ7zEBHFwPUTuBFReipmF7ozY/view?usp=sharing");


//https://drive.google.com/uc?export=view&id=168eLF2ZFZ7zEBHFwPUTuBFReipmF7ozY/view?usp=sharing*/
